    ...
    >
      ...
      <div className="container">
        <div className="hero-copy">
          ...
          <h1>The <span className="hl-accent">firewall</span> between<br />your AI agents and production</h1>
          <p className="lead">Every outbound request pierces the barrier. What ripples through is what your policy allows — <span className="hl-mask">masked</span>, <span className="hl-pause">held</span>, or <span className="hl-deny">bounced</span> before it lands.</p>

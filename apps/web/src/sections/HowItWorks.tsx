    ...
    <section className="section lp" id="how">
      <div className="container">
        ...
        <div className="flow">
          ...
          <div className="flow-node layer"><span className="n-t">Layer 1</span><span className="n-l">Egress filter</span><span className="n-s">domain allow/deny rules</span></div>
          <span className="flow-arrow">→</span>
        ...
        <div className="facts-strip"><b>parsed on the wire</b><code>sql.verb</code><code>sql.table</code><code>k8s.resource</code><code>k8s.verb</code><code>http.method</code><code>http.path</code></div>
      </div>
    </section>
  )
}

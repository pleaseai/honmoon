...
description: The three residual gaps in the audit-sink open after #138 — symlinked parent (#160), pre-existing mode and the hard-link/hostile-pre-creation bypass (both #161) — all documented in-code, do not re-report as unnamed
metadata:
  type: project
---

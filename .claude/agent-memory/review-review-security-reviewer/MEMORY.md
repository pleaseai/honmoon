...
- [Approval hold abandonment model](approval-hold-abandonment-model.md) — pause-hold disconnect watch, biased select, and the MAX_HELD_PIPELINE cap that reopens #102

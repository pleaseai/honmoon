...
- [PR #137 Decision::Degraded](pr137_degraded_decision_variant.md) — README/rustdoc/TS accurate; wiki Decision-enum tables + roadmap "every verdict" went stale, diff didn't touch them

...
```
<!-- Sources: crates/honmoon-proxy/src/gateway.rs:81-131, crates/honmoon-core/src/engine.rs:19-28, crates/honmoon-core/src/protocols.rs:17-156 -->

::: tip What flows today vs later
Over a Phase 1 CONNECT tunnel the gateway sees only the **host** — it builds `Facts{domain,
http.host}` ([gateway.rs:100-111](https://github.com/pleaseai/honmoon/blob/main/crates/honmoon-proxy/src/gateway.rs#L100-L111)).

...
([main.rs:36-225](https://github.com/pleaseai/honmoon/blob/main/crates/honmoon-cli/src/main.rs#L36-L225)).
...
```
<!-- Sources: crates/honmoon-cli/src/main.rs:36-225 (the run, gateway and join variants of Command), main.rs:325-383 (dispatch), main.rs:586-788 (gateway), main.rs:792-912 (run) -->

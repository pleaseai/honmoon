...
([README.md:19-23](https://github.com/pleaseai/honmoon/blob/master/README.md#L19-L23)).
...
only) ([product.md:13-18](https://github.com/pleaseai/honmoon/blob/master/.please/docs/knowledge/product.md#L13-L18)).
...
([README.md:11-17](https://github.com/pleaseai/honmoon/blob/master/README.md#L11-L17)):
...
`sql.verb == 'DROP'` ([product.md:57-60](https://github.com/pleaseai/honmoon/blob/master/.please/docs/knowledge/product.md#L57-L60)).

## Dual-plane design

The monorepo separates languages by responsibility — a hard architectural boundary, not a
preference ([ARCHITECTURE.md:26-49](https://github.com/pleaseai/honmoon/blob/master/ARCHITECTURE.md#L26-L49)):
...
pure and unit-testable without a runtime ([ARCHITECTURE.md:47-48](https://github.com/pleaseai/honmoon/blob/master/ARCHITECTURE.md#L47-L48)).

## Operating modes

Honmoon is designed for three deployment shapes. Only the first two are wired today; `join` is
a stub ([main.rs:58-60](https://github.com/pleaseai/honmoon/blob/master/crates/honmoon-cli/src/main.rs#L58-L60)).
...
See [tech-debt-tracker.md:11](https://github.com/pleaseai/honmoon/blob/master/.please/docs/tracks/tech-debt-tracker.md#L11).
:::
